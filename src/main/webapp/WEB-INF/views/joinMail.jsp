...
.w3-container3, .w3-panel {
	width: 632px;
	border-radius: 30px;
	background-color: #ffffff;
}

.w3-container4, .w3-panel {
	width: 632px;
	border-radius: 30px;
	background-color: #ffffff;
}

.w3-container5, .w3-panel {
	width: 632px;
	border-radius: 30px;
	background-color: #ffffff;
}
...
<body>
	...
	<div class="w3-content w3-container w3-margin-top w3-center">
		...
		<div class="w3-container w3-card-4">
			<br> <br>
			<div
				style="background-color: #FF4D80; width: 59%; height: 6%; text-align: center; color: white; margin-top: 175px; border-radius: 14%; border-radius: 28.5px; border: solid 1px; width: 40%; left: 454px; position: absolute;">
				<h3>인증 메일을 발송 하였습니다. 메일 인증을 진행해주세요!</h3>
			</div>
			<br>
