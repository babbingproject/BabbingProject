...
<body>
	<div class="w3-center">
		<div id="logoBack"><a href="index"><img src="images/Bobbing-logo.png" alt="밥빙 logo" /></a></div>
				...
				<form id="joinForm" action="/join" method="post">
					...
					<p>
						<input type="text" class="w3-input" name="user_email"
							id="user_email" placeholder="이메일(example@naver.com)" required="required">
					...
					<p>
						<br> <a
							href="${url}">
							<img src="${pageContext.request.contextPath}/images/네아로.png"
