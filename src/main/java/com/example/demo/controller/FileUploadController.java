...
public class FileUploadController {
	...
	// 파일 명 랜덤생성 메서드
	private String uploadFile(String originalFileName, byte[] fileData) throws
	  Exception { //uuid 생성 (universal unique identifier, 범용 고유 식별자)
	...
	public ResponseEntity<byte[]> displayFile(String fileName) throws Exception{
		...
		try {
			...
			//이미지가 아니면
				...
				headers.setContentType(mType);
				//
				//바이트 배열을 스트링으로 : new String(fileName.getBytes("UTF-8),"iso-8859")*iso-8859-1 서유럽언어, 큰 따옴표 내부에 "\"내용\" "
				//파일의 한글 깨짐 방지
