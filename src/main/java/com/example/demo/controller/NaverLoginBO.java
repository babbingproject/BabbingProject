...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "jkWx0qkYPPbYyovMQr1f";
	private final static String CLIENT_SECRET = "HkDi6zQn7x";
	private final static String REDIRECT_URI = "http://localhost:80/callback";
